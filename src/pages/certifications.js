    ...
    render() {
        return (
            <div id="cert-page">
                ...
                <Fade bottom>
                    <h3 className="heading-cert"> <a className="number-about" href="/resume"> 03. </a> My Blogs </h3>
                </Fade>
                            ...
                            <Column className="col1" flexGrow={1}>
                                <Row wrap horizontal='spaced'>
                                    ...
                                    <Column className="card" flexGrow={1} horizontal='spaced'>
                                        ...
                                        <a <img src="https://images-na.ssl-images-amazon.com/images/I/51ttX5vtr-L._AC_.jpg"  </a>
